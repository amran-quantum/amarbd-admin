<template>
  <div>
   <Modal
      v-model="addJournalistModal"
      title="Add a new Journalist"
      :mask-closable="false"
      :closable="false"
    >
      <div class="row">
        <div class="col-6 col-md-6">
          <div class="_3login_input_group">
            ...
            <Input
              type="text"
              v-model="form_journalist_data.fullName"
        ...
        <div class="col-6 col-md-6">
          <div class="_3login_input_group">
            ...
            <Input
              type="text"
              v-model="form_journalist_data.email"
              placeholder="Email"
            />
          </div>
        </div>
        <div class="col-6 col-md-6">
          <div class="_3login_input_group">
            ...
            <Input
              type="text"
              v-model="form_journalist_data.password"
      ...
      <div slot="footer">
        <Button type="default" @click="addJournalistModal = false">Close</Button>
        <Button
          type="primary"
          :disabled="isSending"
          :loading="isSending"
          @click="addJournalist"
          >{{ isSending ? "Please wait..." : "Add Journalist" }}</Button
        >
      </div>
    </Modal>
    <Modal
      ...
      <div class="col-12 col-md-12 col-lg-12">
        <div class="_1card _mar_b15 _b_radious7 _5box_shadow _0border">
          <div class="_1card_header _padd20">
            <p
              v-if="authUser.userType == 'journalist'"
              class="_1card_header_title"
            >
              Journalist Area
            </p>
            <div v-if="authUser.userType == 'admin'" class="_1card_header_title"> 
              <p>Total news : {{dashboard_data.total_news}} </p>
               <p>Total published news : {{dashboard_data.published_news}} </p>
               <p>Total journalist : {{dashboard_data.total_journalist}} </p>
              
            </div>
            <div v-if="authUser.userType == 'admin'" class="_dashboard_actions">
              <button class="_btn_sm" @click="addJournalistModal = true">
                <i class="fas fa-plus"></i> Add Journalist
              </button>
            </div>
...
export default {
  data() {
    return {
      ...
      addJournalistModal: false,
      form_journalist_data: {
        fullName: "",
        email: "",
        password: ""
      },
  ...
  methods: {
    ...
    async addJournalist() {
      ...
      if (this.form_journalist_data.fullName.trim() == "") {
        this.isSending = false;
        return this.e("Full Name can not be empty!");
      }

      if (this.form_journalist_data.email.trim() == "") {
        this.isSending = false;
        return this.e("Email can not be empty!");
      }
      if (this.form_journalist_data.password.trim() == "") {
        this.isSending = false;
        return this.e("Password can not be empty!");
      }

      const response = await this.callApi(
        "post",
        "createJournalist",
        this.form_journalist_data
      );
